...
# --- XÂY DỰNG MÔ HÌNH DỰ BÁO GIÁ ---
    ...
    **residual_z = (residual − mean_ref) / std_ref**
    ...
    - **Vi phạm min/max** (Giá thực nằm ngoài khoảng giá tối thiểu/tối đa của phân khúc)
    - **Vi phạm p10/p90** (Giá thực thấp hơn phân vị 10% hoặc cao hơn phân vị 90%)
    - **|residual_z| ≥ 2** (Độ lệch chuẩn hoá quá lớn), trong đó:
